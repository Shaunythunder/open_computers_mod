...
/*    */ 
/*    */ @ScalaSignature(bytes = "\006\001m:Q!\001\002\t\0025\t\021\003V3na2\fG/\032\"mC\016\\G.[:u\025\t\031A!\001\005uK6\004H.\031;f\025\t)a!\001\004d_6lwN\034\006\003\017!\t!a\\2\013\005%Q\021aA2jY*\t1\"\001\002mS\016\001\001C\001\b\020\033\005\021a!\002\t\003\021\003\t\"!\005+f[Bd\027\r^3CY\006\0347\016\\5tiN\021qB\005\t\003'Yi\021\001\006\006\002+\005)1oY1mC&\021q\003\006\002\007\003:L(+\0324\t\013eyA\021\001\016\002\rqJg.\033;?)\005i\001\002\003\017\020\021\013\007I\021B\017\002\031QCWM\0217bG.d\027n\035;\026\003y\0012aE\020\"\023\t\001CCA\003BeJ\f\027\020\005\002#S5\t1E\003\002%K\005!\021\016^3n\025\t1s%A\005nS:,7M]1gi*\t\001&A\002oKRL!AK\022\003\023%#X-\\*uC\016\\\007\002\003\027\020\021\003\005\013\025\002\020\002\033QCWM\0217bG.d\027n\035;!\021\025qs\002\"\0010\003!\021XmZ5ti\026\024H#\001\031\021\005M\t\024B\001\032\025\005\021)f.\033;\t\013QzA\021A\033\002\r\031LG\016^3s)\t1\024\b\005\002\024o%\021\001\b\006\002\b\005>|G.Z1o\021\025Q4\0071\001\"\003\025\031H/Y2l\001")
/*    */ public final class TemplateBlacklist {
/*    */   public static boolean filter(ItemStack paramItemStack) {
/*    */     return TemplateBlacklist$.MODULE$.filter(paramItemStack);
/*    */   }
/*    */   
...
/*    */     
/*    */     public final Option<ItemStack> apply(String x0$1) {
/*    */       // Byte code:
/*    */       //   0: aload_1
/*    */       //   1: astore_2
/*    */       //   2: aload_0
...
/*    */     }
/*    */     
/*    */     public TemplateBlacklist$$anonfun$TheBlacklist$2(Regex pattern$1) {}
/*    */   }
/*    */   
/*    */   public final class TemplateBlacklist$$anonfun$TheBlacklist$1 extends AbstractPartialFunction<Option<ItemStack>, ItemStack> implements Serializable { public static final long serialVersionUID = 0L;
/*    */     
/*    */     public final <A1 extends Option<ItemStack>, B1> B1 applyOrElse(Option x1, Function1 default) { Object object;
/* 35 */       Option option = x1;
/* 36 */       if (option instanceof Some) { Some some = (Some)option; ItemStack stack = (ItemStack)some.x(); } else { object = default.apply(x1); }  return (B1)object; } public final boolean isDefinedAt(Option x1) { boolean bool; Option option = x1; if (option instanceof Some) { bool = true; }
/*    */       else
/*    */       { bool = false; }
/*    */       
/*    */       return bool; }
/*    */      }
/*    */   public final class TemplateBlacklist$$anonfun$filter$1 extends AbstractFunction1<ItemStack, Object> implements Serializable { public static final long serialVersionUID = 0L; private final ItemStack stack$1;
/*    */     
/*    */     public final boolean apply(ItemStack x$1) {
/* 45 */       return x$1.func_77969_a(this.stack$1);
/*    */     }
/*    */     
/*    */     public TemplateBlacklist$$anonfun$filter$1(ItemStack stack$1) {} }
/*    */ 
/*    */ }
