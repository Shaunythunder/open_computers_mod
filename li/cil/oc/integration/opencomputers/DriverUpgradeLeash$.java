...
/* 21 */     if (environmentHost instanceof Entity) { Entity entity = (Entity)environmentHost; managedEnvironment = (ManagedEnvironment)new UpgradeLeash(entity); }
