...
/* 23 */     if (environmentHost instanceof li.cil.oc.api.internal.Rotatable) { EnvironmentHost environmentHost1 = environmentHost; managedEnvironment = (ManagedEnvironment)new UpgradeSignInRotatable(environmentHost1); }
/* 24 */     else if (environmentHost instanceof li.cil.oc.api.internal.Adapter) { EnvironmentHost environmentHost1 = environmentHost; managedEnvironment = (ManagedEnvironment)new UpgradeSignInAdapter(environmentHost1); }
/* 25 */     else { managedEnvironment = null; }
/*    */     
/*    */     return (host.world() != null && (host.world()).field_72995_K) ? null : managedEnvironment; } public String slot(ItemStack stack) {
/* 28 */     return li.cil.oc.common.Slot$.MODULE$.Upgrade();
/*    */   }
/*    */ }
