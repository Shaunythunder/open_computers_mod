...
/* 21 */     if (environmentHost instanceof li.cil.oc.api.internal.Rotatable) { EnvironmentHost environmentHost1 = environmentHost; managedEnvironment = (ManagedEnvironment)new UpgradeNavigation(environmentHost1); }
