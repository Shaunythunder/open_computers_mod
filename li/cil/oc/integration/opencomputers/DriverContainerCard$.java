...
/* 23 */     return li.cil.oc.common.Slot$.MODULE$.Card();
...
/* 29 */     if (option instanceof Some) { Some some = (Some)option; Delegate container = (Delegate)some.x(); if (container instanceof UpgradeContainerCard) { UpgradeContainerCard upgradeContainerCard = (UpgradeContainerCard)container; return upgradeContainerCard.tier(); }  }
/* 30 */      return 0;
/*    */   }
/*    */ }
