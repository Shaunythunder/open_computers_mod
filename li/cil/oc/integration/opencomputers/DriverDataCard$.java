...
/*    */   public static final DriverDataCard$ MODULE$;
/*    */   
...
/* 15 */     (new ItemInfo[3])[0] = 
/* 16 */       Items.get("dataCard1");
/* 17 */     (new ItemInfo[3])[1] = Items.get("dataCard2");
/* 18 */     (new ItemInfo[3])[2] = Items.get("dataCard3");
/*    */     return isOneOf(stack, (Seq<ItemInfo>)scala.Predef$.MODULE$.wrapRefArray((Object[])new ItemInfo[3]));
/*    */   }
/*    */   public ManagedEnvironment createEnvironment(ItemStack stack, EnvironmentHost host) {
/* 22 */     int i = tier(stack); switch (i) { default: case 2: case 1: 
/* 23 */       case 0: break; }  return (host.world() != null && (host.world()).field_72995_K) ? null : (ManagedEnvironment)new DataCard.Tier1();
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   public String slot(ItemStack stack) {
/* 29 */     return li.cil.oc.common.Slot$.MODULE$.Card();
/*    */   }
/*    */   public int tier(ItemStack stack) {
/* 32 */     Option option = li.cil.oc.common.item.Delegator$.MODULE$.subItem(stack);
/* 33 */     if (option instanceof Some) { Some some = (Some)option; Delegate data = (Delegate)some.x(); if (data instanceof DataCard) { DataCard dataCard = (DataCard)data; return dataCard.tier(); }  }
/* 34 */      return 0;
/*    */   }
/*    */ }
