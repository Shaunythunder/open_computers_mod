...
/* 21 */     if (environmentHost instanceof Robot) { Robot robot = (Robot)environmentHost; managedEnvironment = (ManagedEnvironment)new UpgradeCrafting(robot); }
