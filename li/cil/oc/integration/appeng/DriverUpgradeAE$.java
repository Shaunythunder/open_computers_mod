...
/* 22 */       (ManagedEnvironment)new UpgradeAE(host, tier(stack));
...
/* 28 */     if (option instanceof Some) { Some some = (Some)option; Delegate card = (Delegate)some.x(); if (card instanceof ItemUpgradeAE) { ItemUpgradeAE itemUpgradeAE = (ItemUpgradeAE)card; return itemUpgradeAE.tier(); }  }
/* 29 */      return 0;
/*    */   }
/*    */ }
