...
/*    */ {
/*    */   public static final DriverCommandBlock$ MODULE$;
/*    */   
/*    */   private DriverCommandBlock$() {
/* 20 */     MODULE$ = this; } public Class<?> getTileEntityClass() {
/* 21 */     return TileEntityCommandBlock.class;
/*    */   }
/*    */   public ManagedEnvironment createEnvironment(World world, int x, int y, int z, ForgeDirection side) {
/* 24 */     return (ManagedEnvironment)new DriverCommandBlock.Environment((TileEntityCommandBlock)world.func_147438_o(x, y, z));
/*    */   }
/*    */ }
