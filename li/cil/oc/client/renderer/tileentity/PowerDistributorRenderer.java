...
public final class PowerDistributorRenderer {
  public static void renderTileEntityAt(TileEntity paramTileEntity, double paramDouble1, double paramDouble2, double paramDouble3, float paramFloat) {
    PowerDistributorRenderer$.MODULE$.func_147500_a(paramTileEntity, paramDouble1, paramDouble2, paramDouble3, paramFloat);
  }
  ...
  public static void func_147496_a(World paramWorld) {
    PowerDistributorRenderer$.MODULE$.func_147496_a(paramWorld);
  }
  
  public static void func_147497_a(TileEntityRendererDispatcher paramTileEntityRendererDispatcher) {
    PowerDistributorRenderer$.MODULE$.func_147497_a(paramTileEntityRendererDispatcher);
  }
}
