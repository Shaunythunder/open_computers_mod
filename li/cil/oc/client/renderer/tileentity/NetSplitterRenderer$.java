...
/*    */ 
/*    */ public final class NetSplitterRenderer$ extends TileEntitySpecialRenderer {
/*    */   private NetSplitterRenderer$() {
/* 13 */     MODULE$ = this;
/*    */   } public static final NetSplitterRenderer$ MODULE$; public void func_147500_a(TileEntity tileEntity, double x, double y, double z, float f) {
...
/*    */     
/* 17 */     NetSplitter splitter = (NetSplitter)tileEntity;
/* 18 */     if (scala.Predef$.MODULE$.booleanArrayOps(splitter.openSides()).contains(BoxesRunTime.boxToBoolean(!splitter.isInverted()))) {
...
/* 32 */       t.func_78382_b();
/*    */       
/* 34 */       IIcon sideActivity = li.cil.oc.client.Textures$NetSplitter$.MODULE$.iconOn();
/*    */       
/* 36 */       if (splitter.isSideOpen(ForgeDirection.DOWN)) {
...
/*    */       } 
/*    */       
/* 43 */       if (splitter.isSideOpen(ForgeDirection.UP)) {
...
/*    */       } 
/*    */       
/* 50 */       if (splitter.isSideOpen(ForgeDirection.NORTH)) {
...
/*    */       } 
/*    */       
/* 57 */       if (splitter.isSideOpen(ForgeDirection.SOUTH)) {
...
/*    */       } 
/*    */       
/* 64 */       if (splitter.isSideOpen(ForgeDirection.WEST)) {
...
/*    */       } 
/*    */       
/* 71 */       if (splitter.isSideOpen(ForgeDirection.EAST)) {
...
/* Location:              C:\Users\shame\AppData\Roaming\PrismLauncher\instances\GT_New_Horizons_2.7.4_Java_17-21\.minecraft\mods\OpenComputers-1.10.30-GTNH.jar!\li\cil\oc\client\renderer\tileentity\NetSplitterRenderer$.class
