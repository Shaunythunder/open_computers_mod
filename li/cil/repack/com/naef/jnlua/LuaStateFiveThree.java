...
/*     */ 
/*     */ public class LuaStateFiveThree
/*     */   extends LuaState {
/*     */   protected int arith_operator_id(LuaState.ArithOperator o) {
/*  10 */     switch (o) { case STOP:
/*  11 */         return 0;
/*  12 */       case RESTART: return 1;
/*  13 */       case COLLECT: return 2;
/*  14 */       case COUNT: return 3;
/*  15 */       case COUNTB: return 4;
/*  16 */       case STEP: return 5;
/*  17 */       case SETPAUSE: return 6;
/*  18 */       case SETSTEPMUL: return 7;
/*  19 */       case ISRUNNING: return 8;
/*  20 */       case null: return 9;
/*  21 */       case null: return 10;
/*  22 */       case null: return 11;
/*  23 */       case null: return 12;
/*  24 */       case null: return 13; }
/*  25 */      return -1;
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   protected int gc_action_id(LuaState.GcAction o) {
/*  31 */     switch (o) { case STOP:
/*  32 */         return 0;
/*  33 */       case RESTART: return 1;
/*  34 */       case COLLECT: return 2;
/*  35 */       case COUNT: return 3;
/*  36 */       case COUNTB: return 4;
/*  37 */       case STEP: return 5;
/*  38 */       case SETPAUSE: return 6;
/*  39 */       case SETSTEPMUL: return 7;
/*  40 */       case ISRUNNING: return 9; }
/*  41 */      return -1;
/*     */   }
/*     */ 
/*     */ 
